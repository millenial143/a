...
$rs = CIBlockElement::GetList(array(), array('IBLOCK_ID'=>17,'ACTIVE'=>'Y'), false, false, array('ID','NAME','PREVIEW_PICTURE','PROPERTY_HREF','PREVIEW_TEXT'));
    ...
    <div class="container">
        ...
        <div class="main-banners">
            ...
            <?  foreach ($slides as $key => $value) {?>
                ...
                <a class="slide" <? if ($value['PROPERTY_HREF_VALUE']) {?>href="<?=$value['PROPERTY_HREF_VALUE']?>" <?}?>>

                    <div class="main-banner">

                        <span class="main-banner__bg" style="background: #3DC7E4"></span>

                        <div class="main-banner__text"><?=$value['PREVIEW_TEXT']?></div>

                        <div class="main-banner__img" style="background: #fff"><img src="<?=CFile::GetPath($value['PREVIEW_PICTURE']);?>" alt=""></div>
...
<?$APPLICATION->IncludeComponent(
    ...
    <script type="text/javascript" src="/bitrix/templates/xml_catalog/js/slider.js"></script>
